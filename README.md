...
- **역할( MariaDB설계, 사용자 앱 제작 )**<br> 
   ...
   3. 자동로그인 구현
   4. 인벤 인디뉴스 게시판 , 인디게임 카페 게시판 크롤링을 통해  인디게임 정보제공<br>
...
&nbsp; &nbsp; 이번 기회를 통해서 프로그램의 퍼포먼스의 효율을 높혀주는 여러 기술들이 많다는 것을 알았고, 새로운것을 알아간다는 것에 재미도 다시 한번 느낄 수 있었습니다. 또 뒤쳐지지 않는 개발자가 되기 위해 기술 블로그, 컨퍼런스를 자주 찾아보는 습관을 들여야겠다 생각했습니다.
